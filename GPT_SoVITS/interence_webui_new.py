...
with gr.Blocks(title="GPT-SoVITS WebUI") as app:
    ...
    with gr.Group():
        ...
        with gr.Row():
            ...
            button1.click(generator.cut1, [text_inp], [text_opt])
            button2.click(generator.cut2, [text_inp], [text_opt])
            button3.click(generator.cut3, [text_inp], [text_opt])
            button4.click(generator.cut4, [text_inp], [text_opt])
            button5.click(generator.cut5, [text_inp], [text_opt])
